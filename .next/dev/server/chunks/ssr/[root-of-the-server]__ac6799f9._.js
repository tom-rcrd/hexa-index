        ...
        if (mapRef.current.getSource('lieux')) {
            ...
            mapRef.current.on('click', 'lieux-circles', (e)=>{
                ...
                const lieuxHTML = lieuxArray.map((l)=>{
                    ...
                    const nouveauBadge = isNew(l.created_at) ? `<span style="background-color: #10b981; color: white; font-size: 10px; font-weight: bold; padding: 2px 6px; border-radius: 3px; margin-left: 4px;">NOUVEAU</span>` : '';
                    return `<div 
              data-lieu-id="${l.id}"
              style="
                margin: 4px 0; 
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac6799f9._.js.map