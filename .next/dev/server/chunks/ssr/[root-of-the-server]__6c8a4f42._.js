...
function FavorisPage() {
    const { favoris, viderFavoris, exporterFavoris, count, ajouterFavori } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$FavorisContext$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFavoris"])();
    ...
    const [lieuxAffiches, setLieuxAffiches] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const TAG_COLORS = [
        "#9FFFCA",
        "#FFAEFF",
        "#FFAC88",
    ...
    // Gérer l'affichage : favoris perso ou collection partagée
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (hasCollection && collectionChargee?.lieux_data) {
            setLieuxAffiches(collectionChargee.lieux_data);
        } else {
            setLieuxAffiches(favoris);
        }
    }, [
        favoris,
        collectionChargee,
    ...
    const importerCollectionDansFavoris = ()=>{
        if (!collectionChargee?.lieux_data) return;
        collectionChargee.lieux_data.forEach((lieu)=>{
            ajouterFavori(lieu);
        });
        alert(`${collectionChargee.lieux_data.length} lieux ajoutés à vos favoris !`);
    };
    const lieuxTries = [
        ...lieuxAffiches
    ].sort((a, b)=>{
        switch(sortBy){
            ...
            case 'recent':
            default:
                return new Date(b.addedAt || b.created_at) - new Date(a.addedAt || a.created_at);
        }
    });
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: hasCollection ? `${lieuxAffiches.length} lieu${lieuxAffiches.length > 1 ? 'x' : ''} dans cette collection` : count === 0 ? "Vous n'avez pas encore de favoris. Explorez les lieux et ajoutez-les en cliquant sur le cœur ❤️" : `${count} lieu${count > 1 ? 'x' : ''} sauvegardé${count > 1 ? 's' : ''}`
                            }, void 0, false, {
                                fileName: "[project]/app/favoris/page.jsx",
                                lineNumber: 148,
                                columnNumber: 11
                    ...
                    hasCollection && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                ...
                                                children: "Vous consultez une collection partagée"
                                            }, void 0, false, {
                                                fileName: "[project]/app/favoris/page.jsx",
                                                lineNumber: 165,
                                                columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: importerCollectionDansFavoris,
                    ...
                    lieuxAffiches.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lieuxAffiches.length === 0 && !hasCollection && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6c8a4f42._.js.map