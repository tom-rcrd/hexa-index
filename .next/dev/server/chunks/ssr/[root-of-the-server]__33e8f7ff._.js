...
function Home() {
    ...
    const loadVilles = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('villes').select('nom').order('nom', {
            ascending: true
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__33e8f7ff._.js.map